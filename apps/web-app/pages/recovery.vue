    ...
    <div
      ...
      <div class="flex w-full flex-col gap-2">
        <div
          ...
          <h2 class="mt-4 flex flex-col gap-1 text-center">
            <span class="text-xl font-medium">Recovery Methods</span>
          </h2>
          <UnUiButton
          ...
          <div class="mt-4">
            <span class="text-gray-12 text-pretty text-xs font-medium"
              >If you can't access any of these then you need to contact our
              support at
              <a
              ...
              >, which may help you recover your account.
            </span>
          </div>
          ...
          <UnUiModal v-model="resetWithPassword">
            ...
            <div class="flex flex-col gap-2">
              <span class="">
                This will use up recovery code and you will be logged in to
                reset your account credentials.
              </span>
              <span class="">
                If you don't immediately reset your account credentials, you
